...
function createBackground(scene) {
    ...
    scene.cbpkMid = scene.add.tileSprite(0, -400, game.config.width, game.config.height, 'cbpk_mid');
    scene.cbpkMid.setOrigin(0, 0);
    scene.cbpkMid.setScrollFactor(0);
    scene.cbpkClose = scene.add.tileSprite(0, -400, game.config.width, game.config.height, 'cbpk_close');
...
class PlayGame extends Phaser.Scene {
    ...
    create() {
        ...
        this.cameras.main.setBounds(100, 100, 8000, 8000);
    ...
    playZoomEvent() {
        if (this.counter === 400) {
            ...
            // this.cameras.main.setScroll(this.player.x + 300, this.player.y + 1000);
        //     // this.cameras.main.startFollow(this.player);
            // this.cameras.main.pan(1000, 1000);
