...
class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet(player.toLowerCase(),
            'assets/neon_graphics/Sprite_' + player + '.png',
...
class PlayGame extends Phaser.Scene {
    ...
    update() {
        ...
        if (this.isUserPressingLeft())
        {
            ...
            this.player.anims.play(playerString + '_left', true);
        }
        else if (this.isUserPressingRight())
        {
            this.player.setVelocityX(860);
            this.player.anims.play(playerString + '_right', true);
        }
        else
        {
            this.player.setVelocityX(0);
            this.player.anims.play(playerString + '_turn');
        }
    ...
    createPlayer() {
        // create player
        this.player = this.physics.add.sprite(PLAYER_START_X, PLAYER_START_Y, player.toLowerCase());
        this.setPlayerAnims(this.player, player.toLowerCase());
    }
